...
from qgis.PyQt.QtWidgets import QAction, QFileDialog, QMessageBox, QSpinBox
from qgis.core import QgsRasterLayer, QgsRasterFileWriter, QgsRasterDataProvider, QgsRasterBandStats, QgsProject, QgsCoordinateReferenceSystem, Qgis, QgsPalettedRasterRenderer, QgsStyle, QgsSingleBandPseudoColorRenderer, QgsColorRampShader, QgsRasterShader, QgsRasterBlock
...
class CelularAutomataMarkovChain:
    ...
    def __init__(self, iface):
        ...
        self.dlg = CelularAutomataMarkovChainDialog()
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'CelularAutomataMarkovChain_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Celular Automata Markov Chain')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('CelularAutomataMarkovChain', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ca_markov_chain/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'CA Markov Chain'),
            callback=self.run,
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Celular Automata Markov Chain'),
                action)
